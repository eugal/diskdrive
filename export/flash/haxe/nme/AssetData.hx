...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("Drone", nme.NME_assets_drone_wav);
			type.set ("Drone", Reflect.field (AssetType, "sound".toUpperCase ()));
			className.set ("Bounce", nme.NME_assets_bounce2_wav);
			type.set ("Bounce", Reflect.field (AssetType, "sound".toUpperCase ()));
			className.set ("HitSwitch", nme.NME_assets_hitswitch_wav);
			type.set ("HitSwitch", Reflect.field (AssetType, "sound".toUpperCase ()));
			className.set ("Shoot", nme.NME_assets_shoot_wav);
			type.set ("Shoot", Reflect.field (AssetType, "sound".toUpperCase ()));
			className.set ("StartSelect", nme.NME_assets_startselect_wav);
			type.set ("StartSelect", Reflect.field (AssetType, "sound".toUpperCase ()));
			className.set ("music", nme.NME_assets_music_wav);
			type.set ("music", Reflect.field (AssetType, "sound".toUpperCase ()));
			className.set ("ended", nme.NME_assets_ended_wav);
			type.set ("ended", Reflect.field (AssetType, "sound".toUpperCase ()));
			className.set ("1", nme.NME_assets_1_wav);
			type.set ("1", Reflect.field (AssetType, "sound".toUpperCase ()));
			className.set ("2", nme.NME_assets_2_wav);
			type.set ("2", Reflect.field (AssetType, "sound".toUpperCase ()));
			className.set ("3", nme.NME_assets_3_wav);
			type.set ("3", Reflect.field (AssetType, "sound".toUpperCase ()));
			className.set ("4", nme.NME_assets_4_wav);
			type.set ("4", Reflect.field (AssetType, "sound".toUpperCase ()));
			...
			className.set ("assets/disk.png", nme.NME_assets_disk_png);
			type.set ("assets/disk.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/endscreen.png", nme.NME_assets_endscreen_png);
			type.set ("assets/endscreen.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/Guy2.png", nme.NME_assets_guy2_png);
			type.set ("assets/Guy2.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			className.set ("assets/kovensky-small.ttf", nme.NME_assets_kovensky_small_ttf);
			type.set ("assets/kovensky-small.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
			className.set ("assets/startscreen.png", nme.NME_assets_startscreen_png);
			type.set ("assets/startscreen.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/switchglow.png", nme.NME_assets_switchglow_png);
			type.set ("assets/switchglow.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/tiled/GameMap.tmx", nme.NME_assets_tiled_gamemap_tmx);
			type.set ("assets/tiled/GameMap.tmx", Reflect.field (AssetType, "text".toUpperCase ()));
			className.set ("assets/tiled/tileset1.png", nme.NME_assets_tiled_tileset1_png);
			type.set ("assets/tiled/tileset1.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
class NME_assets_drone_wav extends flash.media.Sound { }
class NME_assets_bounce2_wav extends flash.media.Sound { }
class NME_assets_hitswitch_wav extends flash.media.Sound { }
class NME_assets_shoot_wav extends flash.media.Sound { }
class NME_assets_startselect_wav extends flash.media.Sound { }
class NME_assets_music_wav extends flash.media.Sound { }
class NME_assets_ended_wav extends flash.media.Sound { }
class NME_assets_1_wav extends flash.media.Sound { }
class NME_assets_2_wav extends flash.media.Sound { }
class NME_assets_3_wav extends flash.media.Sound { }
class NME_assets_4_wav extends flash.media.Sound { }
...
class NME_assets_disk_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_endscreen_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_guy2_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_haxeflixel_svg extends flash.utils.ByteArray { }
class NME_assets_kovensky_small_ttf extends flash.text.Font { }
class NME_assets_startscreen_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_switchglow_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_tiled_gamemap_tmx extends flash.utils.ByteArray { }
class NME_assets_tiled_tileset1_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
